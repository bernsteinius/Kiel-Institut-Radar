...
import type { CreateTopicFormState } from "@/lib/actions/topics";
...
interface TopicFormProps {
  action: (state: CreateTopicFormState, formData: FormData) => Promise<CreateTopicFormState>;
  defaultValues?: TopicFormDefaults;
  heading: string;
  subheading: string;
  submitLabel: string;
